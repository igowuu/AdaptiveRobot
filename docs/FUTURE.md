...
AdaptiveRobot will come up with new releases as fast as possible. Bug fixes, if reported, will be fixed immediately while new features may take more time. Suggestions/issues in the `issues` section in the repository will be responded to and evaluated.
