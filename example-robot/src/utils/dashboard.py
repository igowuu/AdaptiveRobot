...
from adaptive_robot.adaptive_robot import AdaptiveComponent
...
class Dashboard(AdaptiveComponent):
    ...
    def _put_motor_faults(self) -> None:
        ...
        self.nt.putBoolean("Safety/BL/IsBLFault", self.drivetrain.back_left_motor.hasStickyFault())
        self.nt.putBoolean("Safety/BR/IsBRFault", self.drivetrain.back_right_motor.hasStickyFault())
        ...
        self._put_sparkmax_faults("BL", self.drivetrain.back_left_motor)
        self._put_sparkmax_faults("BR", self.drivetrain.back_right_motor)
