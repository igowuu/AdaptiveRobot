...
class TelemetryPublisher:
    ...
    Note: Editing these values through networktables will not work as intended. If that's
    what you want, please use the tunable() method to create a tunable entry.
    """
