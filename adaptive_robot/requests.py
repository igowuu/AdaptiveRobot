...
class AxisController:
    ...
    def __init__(
        ...
        persistingrequests are made.
        
        :param default_source: The default source that the AxisController will reset to if no 
        persistingrequests are made.
        """
        self._requests: dict[str, _AxisRequest] = {}
        self._default = _AxisRequest(default_value, default_priority, float('inf'), default_source)
    ...
    def resolve(self) -> _AxisRequest:
        ...
        valid_requests: list[_AxisRequest] = []
    ...
    @property
    def last_request(self) -> _AxisRequest:
        """
